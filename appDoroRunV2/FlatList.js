...
const Skins = [
  ...
  },
  {
    ...
    nome: 'Omatsuri Mambo',
    preco: 10,
    desc: 'Mambo, Mambo, omatsuri Mambo! Zapu zapu, yura yura, Omatsuri Manbo',
  ...
  },
  {
    ...
    nome: 'Pato',
    preco: 20,
    desc: 'Um pato dançante utilizando um bone descolado',
...
export default function ListSkins() {
  ...
  const criaItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => {setPlayerSkin(item.imagem); falar(item.desc)}}
    >
      ...
      <View style={styles.listaDetalhes}>
        ...
        <Text style={styles.textoForte}>Desc: <Text style={styles.textoNormal}>{item.desc}</Text></Text>
